...
For testing purposes, there's also a ephemeral template (openshift/signalalertsapi-ephemeral) that doesn't create or make use a persistent volume but a emptydir to install signal. 
